...
GroupAdd, programming_tools, ahk_pid 3220 ; vscode
GroupAdd, programming_tools, ahk_pid 4784 ; vscode
...
global AutoGuiW, BkColor, Bottom_OffsetX, Bottom_OffsetY, Bottom_Screen, Bottom_Win, DisplaySec, FixedX, FixedY
	 ...
	 ;GuiPosition := "Fixed Position"

     
; ; ── FORCE FIXED‑POSITION & ENABLE DRAG ──
; GuiPosition := "Fixed Position"
; OSD_EnableDrag()
...
CreateGUI() {
	...
	; The +E0x20 makes the window ignore mouse events, so clicks pass through to whatever is behind it. That’s perfect for HUD-style overlays, but not if you want to click and drag.
...
CreateHotkey() {
	...
	;            . "|Del|Insert|Home|End|PgUp|PgDn|Up|Down|Left|Right|ScrollLock|CapsLock|NumLock|Pause|sc145|sc146|sc046|sc123"
    	Otherkeys := "Volume_Mute|Volume_Down|Volume_Up|Media_Next|Media_Prev|Media_Stop|Media_Play_Pause|Launch_Media|Launch_App1|Launch_App2|Help|Sleep|PrintScreen|CtrlBreak|Break|AppsKey|NumpadDot|NumpadDiv|NumpadMult|NumpadAdd|NumpadSub|NumpadEnter|Tab|Enter|Esc|BackSpace"
	           . "|Del|Insert|Home|End|PgUp|PgDn|Up|Down|Left|Right|ScrollLock|CapsLock|NumLock|Pause|sc145|sc146|sc046|sc123"
...
ReadSettings() {
	...
	IniRead, ShowMouseButton      , %IniFile%, Settings, ShowMouseButton      , 0
